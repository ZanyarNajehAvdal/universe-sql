...
CREATE TABLE public.holes (
    ...
    name character varying(25) NOT NULL,
    hole_type character varying(25) NOT NULL,
    galaxy_id integer,
    is_warm boolean DEFAULT false NOT NULL
);
...
SELECT pg_catalog.setval('public.holes_holes_id_seq', 1, false);
...
--
-- Name: holes fk_holes; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.holes
    ADD CONSTRAINT fk_holes FOREIGN KEY (galaxy_id) REFERENCES public.galaxy(galaxy_id);
